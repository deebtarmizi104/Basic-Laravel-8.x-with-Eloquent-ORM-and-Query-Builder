...
//CHANGE PASSSWORD AND USER PROFILE ROUTE
...
//USER PROFILE Route
Route::get('/user/profile', [ChangePassController::class, 'DisplayProfile'] )->name('profile.display');
Route::post('/profile/update', [ChangePassController::class, 'UpdateProfile'] )->name('userprofile.update');

Route::middleware(['auth:sanctum', 'verified'])->get('/dashboard', function () {
    $users = User::all();   # variable = model::function READ USER DATA USING ELOQUENT ORM
    $users = DB::table('users')->get();   #READ USER DTA USING QUERY BUILDER
