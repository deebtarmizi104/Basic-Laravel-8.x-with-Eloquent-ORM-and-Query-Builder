  ...
  <tbody>
      ...
      @foreach($brands as $brand)
        <tr>
          ...
          <td> <img src="{{ asset($brand->brand_image) }}" style="height:50px; width:70px;"> </td>    {{--USING ELOQUENT ORM METHOD AFTER JOINING TABLES--}}
          ...
          <td>
            ...
            @else
            {{ Carbon\Carbon::parse($brand->created_at)->diffForHumans() }}      {{--QUERY BUILDER METHOD--}}
            @endif
          </td>
          <td>
